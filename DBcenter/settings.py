"""
Django settings for DBcenter project.
...
SECRET_KEY = 'f(6zky8nr!e287e!wfdlyi33dg1j^#cd!wwpavkc7$ltvszyi4'
...
WSGI_APPLICATION = 'DBcenter.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'data_center',  # 你要存储数据的库名，事先要创建之
        'USER': 'root',  # 数据库用户名
